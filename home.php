			  	...
			  	<div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="navbarSupportedContent">
				      <ul class="navbar-nav mb-2 mb-lg-0 ml-auto text-center">
				        ...
				        <li class="nav-item font-weight-bold h5">
				          <a class="nav-link" href="about.php">About Covid-19</a>
				        </li>
				        <li class="nav-item font-weight-bold h5">
				        ...
				        <li class="nav-item font-weight-bold h5">
				          <a class="nav-link" href="#care">Care call</a>
				        </li>
			...
			<div class="container-fluid">
				<div class="row mt-5">
					...
					<div class="col-lg-6 col-md-6 col-12 pt-4 pb-2 px-3 shadow border rounded-lg">
						...
						<!-- <button class="btn btn-warning rounded-pill"><a href="about.php" class="text-decoration-none text-dark">Read more</a></button> -->
					</div>
				</div>
			</div>
...
<!-- -------------------------------------------------------------------------- Precautions START ------------------------------------------------------------------------ -->
		...
		<div class="container-fluid py-5 precautions border-top" id="precautions">
			<div class="Section_heading text-center mb-5 mt-5">
				...
				<div class="row pt-3 pb-3">
					<div class="col-lg-4 col-md-4 col-12 mb-2">
						<div class="row pt-3">
							...
							<div class="col-lg-8 col-md-8 col-12">
								<p> Wash your hands frequently with Soap, Handwash or Sanitize it.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-12">
					...
					<div class="col-lg-12 col-md-12 col-12 d-flex justify-content-center align-items-center">
						<div class="row pt-3">
							<div class="col-lg-4 col-md-4 col-12">
								<figure class="text-center">
									<img src="images/vaccine.png" class="img-fluid" alt="" height="120" width="120">
								</figure>
							</div>
							<div class="col-lg-8 col-md-8 col-12 d-flex align-items-center">
								<p> Get vaccinated as soon as you can, do your part to fight Corona. We have to fight this together.</p>
							</div>
						</div>
					</div>	
				</div>
...
<!-- --------------------------------------------------------------------- Contact US START  ---------------------------------------------------------------------- -->
		<div class="container-fluid pt-5 pb-3 contact" id="care">
					...
					<div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-12 pb-3 mt-3 form_border">
						<form action="php/contact.php" method="POST">
							<div class="form-group">
								<label class="h5 pt-3">Your Name</label>
								<div class="form-row">
								    <div class="col">
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="describe" rows="2" name="msg"></textarea>
							</div>
							<button type="submit" class="btn btn-s px-5 py-2 font-weight-bold rounded-pill" name="submit">Submit</button>
						</form>
					</div>
				</div>
			</div>
