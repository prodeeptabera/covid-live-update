...
<html>
	<head>
		...
		<title>Covitracker | World</title>

		<!-- <link rel="stylesheet" type="text/css" href="css/common.css"> --><!-- common CSS Style Sheet -->
		<link rel="stylesheet" type="text/css" href="css/world.css">		<!-- world CSS Style Sheet -->
...
<!-- -------------------------------------------------------------------------- Nav Bar START ------------------------------------------------------------------------ -->
			...
			<nav class="navbar navbar-expand-lg fixed-top navbar-dark">
			  	<div class="container-fluid">
				    <a class="navbar-brand mx-4 h4 text-white" href="#hero">Covitracker | World</a>
				    ...
				    <div class="collapse navbar-collapse" id="navbarSupportedContent">
				      <ul class="navbar-nav mb-2 mb-lg-0 ml-auto text-center">
				        ...
				        <li class="nav-item font-weight-bold h5">
				          <a class="nav-link text-white"  id="world_tab" href="world.php">World</a>
				        </li>
				        <li class="nav-item font-weight-bold h5">
...
<section class="covid_update container-fluid py-5" id="world">
	<div class="Section_heading text-center mb-5 mt-5">
		<h1> <u>Covid-19 World Updates</u></h1>
	</div>
	<div class="table-responsive d-flex justify-content-center align-items-center pt-2">
		<table class="table-bordered table-striped text-center" id="w_table">
			<tr>
				<th class="px-4 py-2 font-weight-bold">Country</th>
				...
				<th class="px-4 py-2 font-weight-bold">New Confirmed Cases</th>
				<th class="px-4 py-2 font-weight-bold">New Recoverd</th>
				<th class="px-4 py-2 font-weight-bold">New Deaths</th>
			</tr>
		</table>
